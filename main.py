...
while has_more is True:
    count = 0
    # Each page from the URL only pulls the first 175 cards
    for cards in range(175):
        try:
            ...
            count += 1
            sleep(0.1)
        # The except KeyError is to pull flip cards which are stored differently than normal cards
        except KeyError:
            column = 0
            ...
            for card_side in range(2):
                lst = [(js["data"][count]["card_faces"][card_side]["name"]),
